...
* Inside a [eswardudi/python-ffmpeg](https://hub.docker.com/r/eswardudi/python-ffmpeg) Docker container, so the script has the Python and FFmpeg needed for video automation.
